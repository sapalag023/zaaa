...
+-----------------------------------------+
|#Author:      THF ADMIN                  |
|#Contact: degirmenmuaz@gmail.com         |
|#Date:          12/02/2017               |
|#Bu Tool pentesting icin Yapildi.        |
|#Bu programdan basiniza gelebilecek      |
|herhangi birseyden sorumlu degiliz!      |
+=========================================+
|.........ADMIN PANEL BULUCU...........|
+-----------------------------------------+
''')
print(" \033[95m PROTOKOL YAZMALISIN HTTPS:// or HTTP:// ex: http://www.ex.com , ex :https://www.ex.com ")
print(" \033[95m PROTOKOL / SONUNADA Site SITE EX: www.example.com/")
print("                                                                       ")
url = input("\033[97m Site Adresi => ")
...
'bb-admin/index.html','bb-admin/login.html','acceso.php','cpanel/','bb-admin/admin.html','admin/home.html','login.php','modelsearch/login.php','moderator.php','moderator/login.php',
...
for hani in passe :
    ...
    try :
        ...
        print("                                                             ")
        print("\033[92m :::: UYARI::: ADMIN CP BULUNDU ::: "+curl)
        print("_____________________________________________________________")
...
print ("----------------------------------------------------------------------------------------")
print ("\033[93m     UMARIM YARDIMCI OLMUSUMDUR ^_^ , CODER -THF ADMIN-")
print ("----------------------------------------------------------------------------------------")
